...
class RecyclerViewSliderAdapter(val categoryList: List<TabModel>, val context: Context, val itemSelected: ItemData) : RecyclerView.Adapter<RecyclerViewSliderAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        itemDetailViewModel.getItemDetail(categoryList[position].categoryEndpointURL).observe(context) {
        ...
        itemDetailViewModel.isDataLoading().observe(context) {
            if (it)
        ...
        itemDetailViewModel.getError().observe(context) {
